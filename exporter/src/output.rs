...
/// The auto-generated directory will be named "sample_frames".
...
fn output_directory_auto_generated(input_path: &Path) -> Result<PathBuf> {
    // Use "sample_frames" as the base directory name.
    ...
    // If "sample_frames" already exists, append a random suffix.
